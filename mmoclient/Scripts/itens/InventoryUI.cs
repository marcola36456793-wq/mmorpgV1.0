...
public class InventoryUI : MonoBehaviour
{
    ...
    // ✅ NOVO: Controle de cooldown local
    ...
    // ✅ CORREÇÃO: Validação local antes de enviar ao servidor
    private void OnUseButtonClick()
    {
        ...
        // ✅ Validação: Verifica se pode usar (HP/MP cheio) usando WorldManager
    ...
    // ✅ HELPER: Obtém dados do player local
