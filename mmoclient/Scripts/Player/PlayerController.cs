...
public class PlayerController : MonoBehaviour
{
    ...
    // ✅ CORREÇÃO: Awake para inicializar componentes ANTES do Start
    private void Awake()
    {
        // Inicializa CharacterController PRIMEIRO
    ...
    private void InterpolateToServerPosition()
    {
        ...
        {
            // ✅ VERIFICA SE O CHARACTERCONTROLLER ESTÁ HABILITADO
            ...
            {
                // Fallback: move diretamente
                transform.position = displayPosition;
                Debug.LogWarning($"⚠️ {characterName}: CharacterController disabled, using direct movement");
            }
        }
    ...
    private void UpdateAnimations()
    {
        ...
        bool isWalking = serverIsMoving && !isDead;
        
        animator.SetBool("isWalking", isWalking);
        animator.SetBool("isDead", isDead);
        animator.SetBool("inCombat", serverInCombat);
    ...
    public void Initialize(string id, string name, bool local, int hp, int maxHp, int lvl)
    {
        ...
        if (isLocalPlayer)
        {
            ...
            // ✅ PARA PLAYER LOCAL: Desabilita collider mas MANTÉM CharacterController
            ...
            // ✅ GARANTE QUE CharacterController ESTÁ HABILITADO
            if (characterController != null)
            {
                characterController.enabled = true;
                Debug.Log($"✅ {characterName} (LOCAL): CharacterController ENABLED");
            }
        }
        else
        {
            ...
            // Para outros players, pode desabilitar CharacterController
            if (characterController != null)
            {
